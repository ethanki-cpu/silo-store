...
**Stage 2 핵심 마일스톤 — 스텝페이(Steppay) 기반 결제 시스템 론칭 및 오픈 준비 (2026-09-20 편입, 2026-09-21 토스페이먼츠 → 스텝페이로 변경, 사용자 지시)**
...
**핵심 마일스톤(2026-09-20 편입, 2026-09-21 스텝페이로 변경)**: 스텝페이 기반 결제 시스템 론칭 및 오픈 준비 — 현재 Phase 1(행정 페이지·푸터 정비) 진행 중, Phase 2(EPIC-159)는 PG 계약 선결 확인 대기. 상세는 위 "Stage 2 핵심 마일스톤" 참고.
