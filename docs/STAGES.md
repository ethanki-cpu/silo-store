...
| Board System | ✅ 완료 | EPIC-047~051 | Board Definition System(`BOARD_DEFINITIONS`/`INDIVIDUAL_BOARD_DEFINITIONS` + `resolveBoardDefinition()` + `BoardRenderer`) — config만으로 새 게시판 추가 가능 |
