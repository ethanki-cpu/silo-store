...
update page_modules m set settings = case m.module_type
  when 'membership_carousel' then '{"heading":"멤버십 혜택 한눈에 보기","subtitle":"옆으로 넘기며 등급마다 열리는 세계를 비교해 보세요. 높은 등급은 낮은 등급의 혜택을 모두 포함해요.","showCategories":true,"showFullList":true,"showNotes":true,"showLetter":true,"excludeCategories":"","commonNotes":"사일로 상점 물품 구매 시 포인트 적립"}'::jsonb
