...
// 연결된다. page_builder(slug="community-topics-economy")의 published 모듈만 렌더링한다.
export default function CommunityTopicsEconomyPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchPublishedPageBySlug("community-topics-economy").then((result) => {
      if (cancelled) return;
  ...
  return (
    <>
      <PageEditButton slug="community-topics-economy" />
