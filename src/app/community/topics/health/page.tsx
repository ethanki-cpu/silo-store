...
// 연결된다. page_builder(slug="community-topics-health")의 published 모듈만 렌더링한다.
export default function CommunityTopicsHealthPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchPublishedPageBySlug("community-topics-health").then((result) => {
      if (cancelled) return;
  ...
  return (
    <>
      <PageEditButton slug="community-topics-health" />
