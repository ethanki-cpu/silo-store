...
// 연결된다. page_builder(slug="community-topics-movie")의 published 모듈만 렌더링한다.
export default function CommunityTopicsMoviePage() {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchPublishedPageBySlug("community-topics-movie").then((result) => {
      if (cancelled) return;
  ...
  return (
    <>
      <PageEditButton slug="community-topics-movie" />
