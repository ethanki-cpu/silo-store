...
// 연결된다. page_builder(slug="community-topics")의 published 모듈만 렌더링한다.
export default function CommunityTopicsHubPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchPublishedPageBySlug("community-topics").then((result) => {
      if (cancelled) return;
  ...
  return (
    <>
      <PageEditButton slug="community-topics" />
