...
// 연결된다. page_builder(slug="community-topics-science")의 published 모듈만 렌더링한다.
export default function CommunityTopicsSciencePage() {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchPublishedPageBySlug("community-topics-science").then((result) => {
      if (cancelled) return;
  ...
  return (
    <>
      <PageEditButton slug="community-topics-science" />
