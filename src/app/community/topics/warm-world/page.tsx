...
// 연결된다. page_builder(slug="community-topics-warm-world")의 published 모듈만 렌더링한다.
export default function CommunityTopicsWarmWorldPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchPublishedPageBySlug("community-topics-warm-world").then((result) => {
      if (cancelled) return;
  ...
  return (
    <>
      <PageEditButton slug="community-topics-warm-world" />
