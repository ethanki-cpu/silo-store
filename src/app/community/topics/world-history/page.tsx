...
// 연결된다. page_builder(slug="community-topics-world-history")의 published 모듈만 렌더링한다.
export default function CommunityTopicsWorldHistoryPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchPublishedPageBySlug("community-topics-world-history").then((result) => {
      if (cancelled) return;
  ...
  return (
    <>
      <PageEditButton slug="community-topics-world-history" />
