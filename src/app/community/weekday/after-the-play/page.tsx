...
// 연결된다. page_builder(slug="community-weekday-after-the-play")의 published 모듈만 렌더링한다.
export default function CommunityWeekdayAfterThePlayPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchPublishedPageBySlug("community-weekday-after-the-play").then((result) => {
      if (cancelled) return;
  ...
  return (
    <>
      <PageEditButton slug="community-weekday-after-the-play" />
