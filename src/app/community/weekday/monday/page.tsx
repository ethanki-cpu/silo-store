...
// 연결된다. page_builder(slug="community-weekday-monday")의 published 모듈만 렌더링한다.
export default function CommunityWeekdayMondayPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchPublishedPageBySlug("community-weekday-monday").then((result) => {
      if (cancelled) return;
  ...
  return (
    <>
      <PageEditButton slug="community-weekday-monday" />
