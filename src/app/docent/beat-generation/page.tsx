...
// 연결된다. page_builder(slug="docent-beat-generation")의 published 모듈만 렌더링한다.
export default function DocentBeatGenerationPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchPublishedPageBySlug("docent-beat-generation").then((result) => {
      if (cancelled) return;
  ...
  return (
    <>
      <PageEditButton slug="docent-beat-generation" />
