...
// 연결된다. page_builder(slug="docent-counterculture")의 published 모듈만 렌더링한다.
export default function DocentCounterculturePage() {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchPublishedPageBySlug("docent-counterculture").then((result) => {
      if (cancelled) return;
  ...
  return (
    <>
      <PageEditButton slug="docent-counterculture" />
