...
// 연결된다. page_builder(slug="docent-neoclassicism")의 published 모듈만 렌더링한다.
export default function DocentNeoclassicismPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchPublishedPageBySlug("docent-neoclassicism").then((result) => {
      if (cancelled) return;
  ...
  return (
    <>
      <PageEditButton slug="docent-neoclassicism" />
