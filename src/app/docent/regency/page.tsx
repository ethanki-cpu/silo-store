...
// 연결된다. page_builder(slug="docent-regency")의 published 모듈만 렌더링한다.
export default function DocentRegencyPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchPublishedPageBySlug("docent-regency").then((result) => {
      if (cancelled) return;
  ...
  return (
    <>
      <PageEditButton slug="docent-regency" />
