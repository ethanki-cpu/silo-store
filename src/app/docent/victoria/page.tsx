...
// 연결된다. page_builder(slug="docent-victoria")의 published 모듈만 렌더링한다.
export default function DocentVictoriaPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchPublishedPageBySlug("docent-victoria").then((result) => {
      if (cancelled) return;
  ...
  return (
    <>
      <PageEditButton slug="docent-victoria" />
