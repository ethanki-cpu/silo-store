...
// EPIC-068: page_builder(slug="gallery-parties")의 published 모듈만 렌더링한다.
export default function GalleryPartiesPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchPublishedPageBySlug("gallery-parties").then((result) => {
      if (cancelled) return;
  ...
  return (
    <>
      <PageEditButton slug="gallery-parties" />
