...
// EPIC-068: page_builder(slug="heritage-grandmas")의 published 모듈만 렌더링한다.
export default function HeritageGrandmasPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchPublishedPageBySlug("heritage-grandmas").then((result) => {
      if (cancelled) return;
  ...
  return (
    <>
      <PageEditButton slug="heritage-grandmas" />
