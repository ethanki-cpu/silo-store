  ...
  return (
    <LegalDocument title="개인정보처리방침" effectiveDate="2026년 9월 21일" business={business}>
      ...
      <LegalSection title="1. 수집하는 개인정보 항목과 수집 방법">
        ...
        <p>
          다. 유료 결제: 결제 수단 정보는 결제대행사(PG)가 직접 처리하며 회사는 카드 번호를 저장하지 않습니다. 정기결제를 위해
          결제대행사가 발급하는 결제 인증 키(빌링키), 카드사명, 마스킹된 카드 번호, 결제 일시·금액·주문 번호를 저장합니다. 계좌이체로 접수하는 경우
          입금자명과 입금 일시·금액을 저장합니다.
        </p>
      ...
      <LegalSection title="5. 개인정보 처리의 위탁 및 국외 이전">
        ...
        <p>- 스텝페이(Steppay): 정기구독 결제 처리 및 구독 관리(결제 수단 등록, 정기결제, 결제 내역)</p>
        <p>- 결제대행사(PG): 카드 결제 처리 — 스텝페이와 연동하는 결제대행사가 확정되면 업체명을 이 방침에 표시합니다.</p>
