      ...
      return (
        <MembershipCarousel
          options={{
            ...
            layout: settings.layout === "side" ? "side" : "stack",
            textAlign: settings.textAlign === "left" ? "left" : "center",
            cardMaxWidthPx: num(settings.cardMaxWidthPx, MEMBERSHIP_CAROUSEL_DEFAULTS.cardMaxWidthPx),
            cardBackground: str(settings.cardBackground, ""),
            cardRadiusPx: num(settings.cardRadiusPx, MEMBERSHIP_CAROUSEL_DEFAULTS.cardRadiusPx),
            cardBorder: bool(settings.cardBorder, true),
            accentColor: str(settings.accentColor, ""),
            nameSizePx: num(settings.nameSizePx, MEMBERSHIP_CAROUSEL_DEFAULTS.nameSizePx),
            mediaWidthPx: num(settings.mediaWidthPx, MEMBERSHIP_CAROUSEL_DEFAULTS.mediaWidthPx),
            mediaAspect: str(settings.mediaAspect, MEMBERSHIP_CAROUSEL_DEFAULTS.mediaAspect),
            mediaFit: settings.mediaFit === "cover" ? "cover" : "contain",
            mediaRadiusPx: num(settings.mediaRadiusPx, MEMBERSHIP_CAROUSEL_DEFAULTS.mediaRadiusPx),
            mediaBorder: bool(settings.mediaBorder, true),
            mediaBackground: str(settings.mediaBackground, ""),
            showTabs: bool(settings.showTabs, true),
            showArrows: bool(settings.showArrows, true),
            showPrice: bool(settings.showPrice, true),
            showSummary: bool(settings.showSummary, true),
            ...
            showJoin: bool(settings.showJoin, true),
    ...
    case "membership_doors": {
      ...
      return (
        <DoorLobby
          ...
          headerImageUrl={str(settings.headerImageUrl, "")}
          headerImageWidthPx={num(settings.headerImageWidthPx, 160)}
