...
// BoardLayoutType 5종(community/story/gallery/hub/timeline,
// src/lib/boardLayout.ts) 전부를 키로 강제하므로(Record<BoardLayoutType, ...>)
// 새 레이아웃이 boardLayout.ts에 추가되는데 여기 등록을 빠뜨리면 타입
// 에러로 즉시 드러난다.
