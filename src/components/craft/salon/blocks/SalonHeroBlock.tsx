...
export function SalonHeroBlock({ imageUrl, imageUrlMobile, tag, title, subtitle, ctaText, ctaHref }: SalonHeroProps) {
  const {
    connectors: { connect },
    setProp,
  } = useNode();
...
SalonHeroBlock.craft = {
  ...
  props: {
    imageUrl: "https://images.unsplash.com/photo-1517457373958-b7bdd4587205?w=1600&q=80&auto=format",
    tag: "Salon des Cent",
