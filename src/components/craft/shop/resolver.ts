// EPIC-099(항목 3, Phase 2): 사일로 상점 페이지의 Craft resolver. 이 페이지
// 전용 블록(ShopHero/TreasureGrid/SpotlightItem)은 새로 만들고, 페이지 성격과
...
export const craftShopResolver: Resolver = {
  RootContainer,
  ShopHeroBlock,
  TreasureGridBlock,
  SpotlightItemBlock,
